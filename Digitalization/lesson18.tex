...
% Section 111
\newSection \label{section-111} It may seem strange to a non-native speaker that Estonian uses the illative (\m{-sse}) and allative (\m{-le}), which answer the question `where to? whither?', to indicate the place where something remains or is left: \\
...
% Section 113
\newSection \label{section-113} The elative (\m{-st}) and ablative (\m{-lt}) cases, which answer the question `where from? whence?', are used to indicate: \\
