...
% Section 228
\newSection \label{section-228} The genitive plural has the ending \m{-de} or \m{-te}. Like the genitive singular, it answers the questions \m{kelle?} `whose?' and \m{mille?} `belonging to what?'. The genitive plural has the same uses as the singular (Lessons 7 and 9). For example: \\
...
% Section 229
\newSection \label{section-229} a) If the partitive singular ends in a vowel, the genitive plural has the ending \m{-de}, which is added to the partitive singular form. For example:
...
% Section 230
\newSection \label{section-230} b) If the partitive singular ends in \m{-d}, the genitive plural has a \m{-de} ending in place of this \m{-d}.
...
% Section 231
\newSection \label{section-231} c) If the partitive singular ends in \m{-t}, this \m{-t} is replaced by the suffix \m{-te} in the genitive plural.
...
% Section 232
\newSection \label{section-232} One-syllable words, which contain a diphthong before the final consonant \m{1}, \m{n}, \m{r}, or \m{s}, form the genitive plural with the \m{-te} ending, which is added directly to the nominative singular form. For example:
...
% Section 233
\newSection \label{section-233} Some two-syllable words which end in \m{-t} in the partitive singular have the ending \m{-de} in the genitive plural instead of the expected \m{-te}. For example:
...
% Section 234
\newSection \label{section-234} Certain words form the genitive plural by inserting the vowel \m{-e-} between the stem and the \m{-de} ending. In these cases, the \m{-e} is also found in the genitive singular form. There are only six words that show this pattern:
...
% Section 235
\newSection \label{section-235} For some words, the genitive singular has a \m{-me} ending, which is missing from both the nominative and partitive singular. In these cases, the genitive plural has a \m{-me/te} ending.
...
% Section 236
\newSection \label{section-236} Some words have a short form ending in \m{-e} in the genitive plural, along with the regular form.
...
% Section 237
\newSection \label{section-237} The words \m{eks} and \m{ega} are used to begin questions, where one anticipates a definite answer. If the expected answer is affirmative, \m{eks} is used. If the expected answer is negative, \m{ega} is used.
...
% Section 240
\newSection \label{section-240} The combination \m{ei\dots ega} means `neither\dots nor'.
